...
//   - namespace []byte
//   - options []byte
func (_e *MockDA_Expecter) Submit(ctx interface{}, blobs interface{}, gasPrice interface{}, namespace interface{}, options interface{}) *MockDA_Submit_Call {
	return &MockDA_Submit_Call{Call: _e.mock.On("Submit", ctx, blobs, gasPrice, namespace, options)}
}

func (_c *MockDA_Submit_Call) Run(run func(ctx context.Context, blobs [][]byte, gasPrice float64, namespace []byte, options []byte)) *MockDA_Submit_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDA_Submit_Call) RunAndReturn(run func(context.Context, [][]byte, float64, []byte, []byte) ([][]byte, error)) *MockDA_Submit_Call {
	_c.Call.Return(run)
	return _c
}
