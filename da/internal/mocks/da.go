...
func (_m *MockDA) GasMultiplier(ctx context.Context) (float64, error) {
	ret := _m.Called(ctx)
...
func (_c *MockDA_GasMultiplier_Call) Return(_a0 float64, _a1 error) *MockDA_GasMultiplier_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDA_GasMultiplier_Call) RunAndReturn(run func(context.Context) (float64, error)) *MockDA_GasMultiplier_Call {
	_c.Call.Return(run)
	return _c
}

// GasPrice provides a mock function with given fields: ctx
func (_m *MockDA) GasPrice(ctx context.Context) (float64, error) {
	ret := _m.Called(ctx)
...
func (_c *MockDA_GasPrice_Call) Return(_a0 float64, _a1 error) *MockDA_GasPrice_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDA_GasPrice_Call) RunAndReturn(run func(context.Context) (float64, error)) *MockDA_GasPrice_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDA) Submit(ctx context.Context, blobs [][]byte, gasPrice float64, options []byte) ([][]byte, error) {
...
func (_c *MockDA_Submit_Call) Run(run func(ctx context.Context, blobs [][]byte, gasPrice float64, options []byte)) *MockDA_Submit_Call {
	_c.Call.Run(func(args mock.Arguments) {
