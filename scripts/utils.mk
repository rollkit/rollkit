...
mock-gen:
	...
	mockery --output test/mocks --srcpkg github.com/rollkit/rollkit/core/da --name Client --filename="dac.go"
	mockery --output test/mocks --srcpkg github.com/rollkit/rollkit/core/sequencer --name Sequencer --filename="sequencer.go"
	mockery --output test/mocks --srcpkg github.com/rollkit/rollkit/core/execution --name Execution --filename="execution.go"
