...
// PreprocessTxs provides a mock function with given fields: _a0
func (_m *Application) PreprocessTxs(_a0 types.RequestPreprocessTxs) types.ResponsePreprocessTxs {
	ret := _m.Called(_a0)
