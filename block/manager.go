...
func NewManager(
	...
	exec := state.NewBlockExecutor(proposerAddress, conf.NamespaceID, genesis.ChainID, mempool, state.RewindableFromStandard(proxyApp), conf.FraudProofs, eventBus, logger)
