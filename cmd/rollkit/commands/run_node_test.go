...
func TestParseFlags(t *testing.T) {
	flags := []string{
		...
		"--rollkit.da_header_namespace", "header_namespace",
		"--rollkit.da_data_namespace", "data_namespace",
	...
	testCases := []struct {
		...
		{"DAHeaderNamespace", nodeConfig.DAHeaderNamespace, "header_namespace"},
		{"DADataNamespace", nodeConfig.DADataNamespace, "data_namespace"},
