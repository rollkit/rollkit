...
type Header struct {
	...
	// Commit signatures from aggregator(s) from the last block
	LastCommitSignatures [][]byte `protobuf:"bytes,5,rep,name=last_commit_signatures,json=lastCommitSignatures,proto3" json:"last_commit_signatures,omitempty"`
...
func (m *Header) GetLastCommitSignatures() [][]byte {
	if m != nil {
		return m.LastCommitSignatures
	}
	return nil
}
...
var fileDescriptor_ed489fb7f4d78b3f = []byte{
	...
	,
}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LastCommitSignatures) > 0 {
		for iNdEx := len(m.LastCommitSignatures) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.LastCommitSignatures[iNdEx])
			copy(dAtA[i:], m.LastCommitSignatures[iNdEx])
			i = encodeVarintRollkit(dAtA, i, uint64(len(m.LastCommitSignatures[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *Header) Size() (n int) {
	...
	if len(m.LastCommitSignatures) > 0 {
		for _, b := range m.LastCommitSignatures {
			l = len(b)
			n += 1 + l + sovRollkit(uint64(l))
		}
	}
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastCommitSignatures", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LastCommitSignatures = append(m.LastCommitSignatures, make([]byte, postIndex-iNdEx))
			copy(m.LastCommitSignatures[len(m.LastCommitSignatures)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
