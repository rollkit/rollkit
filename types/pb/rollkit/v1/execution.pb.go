...
func (x *SetFinalRequest) Reset() {
	*x = SetFinalRequest{}
	mi := &file_rollkit_v1_execution_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetFinalRequest) Descriptor() ([]byte, []int) {
	return file_rollkit_v1_execution_proto_rawDescGZIP(), []int{6}
}
...
func (x *SetFinalResponse) Reset() {
	*x = SetFinalResponse{}
	mi := &file_rollkit_v1_execution_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetFinalResponse) Descriptor() ([]byte, []int) {
	return file_rollkit_v1_execution_proto_rawDescGZIP(), []int{7}
}
...
const file_rollkit_v1_execution_proto_rawDesc = "" +
	...
	"rollkit.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x01\n" +
	...
	"\x10SetFinalResponse2\xb8\x02\n" +
	"\x0fExecutorService\x12J\n" +
	"\tInitChain\x12\x1c.rollkit.v1.InitChainRequest\x1a\x1d.rollkit.v1.InitChainResponse\"\x00\x12A\n" +
	"\x06GetTxs\x12\x19.rollkit.v1.GetTxsRequest\x1a\x1a.rollkit.v1.GetTxsResponse\"\x00\x12M\n" +
	"\n" +
	"ExecuteTxs\x12\x1d.rollkit.v1.ExecuteTxsRequest\x1a\x1e.rollkit.v1.ExecuteTxsResponse\"\x00\x12G\n" +
	"\bSetFinal\x12\x1b.rollkit.v1.SetFinalRequest\x1a\x1c.rollkit.v1.SetFinalResponse\"\x00B0Z.github.com/rollkit/rollkit/types/pb/rollkit/v1b\x06proto3"
...
var file_rollkit_v1_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_rollkit_v1_execution_proto_goTypes = []any{
	...
	(*GetTxsRequest)(nil),         // 2: rollkit.v1.GetTxsRequest
	(*GetTxsResponse)(nil),        // 3: rollkit.v1.GetTxsResponse
	(*ExecuteTxsRequest)(nil),     // 4: rollkit.v1.ExecuteTxsRequest
	(*ExecuteTxsResponse)(nil),    // 5: rollkit.v1.ExecuteTxsResponse
	(*SetFinalRequest)(nil),       // 6: rollkit.v1.SetFinalRequest
	(*SetFinalResponse)(nil),      // 7: rollkit.v1.SetFinalResponse
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_rollkit_v1_execution_proto_depIdxs = []int32{
	8, // 0: rollkit.v1.InitChainRequest.genesis_time:type_name -> google.protobuf.Timestamp
	8, // 1: rollkit.v1.ExecuteTxsRequest.timestamp:type_name -> google.protobuf.Timestamp
	0, // 2: rollkit.v1.ExecutorService.InitChain:input_type -> rollkit.v1.InitChainRequest
	2, // 3: rollkit.v1.ExecutorService.GetTxs:input_type -> rollkit.v1.GetTxsRequest
	4, // 4: rollkit.v1.ExecutorService.ExecuteTxs:input_type -> rollkit.v1.ExecuteTxsRequest
	6, // 5: rollkit.v1.ExecutorService.SetFinal:input_type -> rollkit.v1.SetFinalRequest
	1, // 6: rollkit.v1.ExecutorService.InitChain:output_type -> rollkit.v1.InitChainResponse
	3, // 7: rollkit.v1.ExecutorService.GetTxs:output_type -> rollkit.v1.GetTxsResponse
	5, // 8: rollkit.v1.ExecutorService.ExecuteTxs:output_type -> rollkit.v1.ExecuteTxsResponse
	7, // 9: rollkit.v1.ExecutorService.SetFinal:output_type -> rollkit.v1.SetFinalResponse
