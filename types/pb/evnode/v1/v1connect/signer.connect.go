...
const (
	...
	SignerServiceSignProcedure = "/evnode.v1.SignerService/Sign"
	// SignerServiceGetPublicProcedure is the fully-qualified name of the SignerService's GetPublic RPC.
	SignerServiceGetPublicProcedure = "/evnode.v1.SignerService/GetPublic"
)
...
// NewSignerServiceClient constructs a client for the evnode.v1.SignerService service. By default,
...
func NewSignerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SignerServiceClient {
	...
	signerServiceMethods := v1.File_evnode_v1_signer_proto.Services().ByName("SignerService").Methods()
...
// Sign calls evnode.v1.SignerService.Sign.
...
// GetPublic calls evnode.v1.SignerService.GetPublic.
...
func NewSignerServiceHandler(svc SignerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/evnode.v1.SignerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSignerServiceHandler) Sign(context.Context, *connect.Request[v1.SignRequest]) (*connect.Response[v1.SignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.SignerService.Sign is not implemented"))
}
...
func (UnimplementedSignerServiceHandler) GetPublic(context.Context, *connect.Request[v1.GetPublicRequest]) (*connect.Response[v1.GetPublicResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evnode.v1.SignerService.GetPublic is not implemented"))
}
