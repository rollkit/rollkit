...
import fmt "fmt"
import math "math"
import tendermint_types1 "github.com/lazyledger/lazyledger-core/proto/tendermint/types"
...
type Commit struct {
	...
	HaderHash  []byte   `protobuf:"bytes,2,opt,name=hader_hash,json=haderHash,proto3" json:"hader_hash,omitempty"`
...
func (m *Commit) GetHaderHash() []byte {
	if m != nil {
		return m.HaderHash
	}
	return nil
...
type Data struct {
	...
	Evidence               []*tendermint_types1.Evidence `protobuf:"bytes,3,rep,name=evidence" json:"evidence,omitempty"`
}
...
func (m *Data) GetEvidence() []*tendermint_types1.Evidence {
	if m != nil {
		return m.Evidence
	}
	return nil
...
func (m *Commit) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.HaderHash) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintOptimint(dAtA, i, uint64(len(m.HaderHash)))
		i += copy(dAtA[i:], m.HaderHash)
	}
...
func (m *Commit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HaderHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HaderHash = append(m.HaderHash[:0], dAtA[iNdEx:postIndex]...)
			if m.HaderHash == nil {
				m.HaderHash = []byte{}
			}
			iNdEx = postIndex
...
func (m *Data) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Evidence = append(m.Evidence, &tendermint_types1.Evidence{})
...
var fileDescriptorOptimint = []byte{
	...
	,
}
