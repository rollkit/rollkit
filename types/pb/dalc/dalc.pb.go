...
// Client API for DataAvailabilityLayerClientService service

type DataAvailabilityLayerClientServiceClient interface {
...
type dataAvailabilityLayerClientServiceClient struct {
	cc *grpc.ClientConn
}

func NewDataAvailabilityLayerClientServiceClient(cc *grpc.ClientConn) DataAvailabilityLayerClientServiceClient {
	return &dataAvailabilityLayerClientServiceClient{cc}
}

func (c *dataAvailabilityLayerClientServiceClient) SubmitBlock(ctx context.Context, in *SubmitBlockRequest, opts ...grpc.CallOption) (*SubmitBlockResponse, error) {
	out := new(SubmitBlockResponse)
	err := grpc.Invoke(ctx, "/dalc.DataAvailabilityLayerClientService/SubmitBlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataAvailabilityLayerClientServiceClient) CheckBlockAvailability(ctx context.Context, in *CheckBlockAvailabilityRequest, opts ...grpc.CallOption) (*CheckBlockAvailabilityResponse, error) {
	out := new(CheckBlockAvailabilityResponse)
	err := grpc.Invoke(ctx, "/dalc.DataAvailabilityLayerClientService/CheckBlockAvailability", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataAvailabilityLayerClientServiceClient) RetrieveBlock(ctx context.Context, in *RetrieveBlockRequest, opts ...grpc.CallOption) (*RetrieveBlockResponse, error) {
	out := new(RetrieveBlockResponse)
	err := grpc.Invoke(ctx, "/dalc.DataAvailabilityLayerClientService/RetrieveBlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for DataAvailabilityLayerClientService service

type DataAvailabilityLayerClientServiceServer interface {
...
func RegisterDataAvailabilityLayerClientServiceServer(s *grpc.Server, srv DataAvailabilityLayerClientServiceServer) {
	s.RegisterService(&_DataAvailabilityLayerClientService_serviceDesc, srv)
}

func _DataAvailabilityLayerClientService_SubmitBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataAvailabilityLayerClientServiceServer).SubmitBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dalc.DataAvailabilityLayerClientService/SubmitBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataAvailabilityLayerClientServiceServer).SubmitBlock(ctx, req.(*SubmitBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DataAvailabilityLayerClientService_CheckBlockAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckBlockAvailabilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataAvailabilityLayerClientServiceServer).CheckBlockAvailability(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dalc.DataAvailabilityLayerClientService/CheckBlockAvailability",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataAvailabilityLayerClientServiceServer).CheckBlockAvailability(ctx, req.(*CheckBlockAvailabilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DataAvailabilityLayerClientService_RetrieveBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetrieveBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataAvailabilityLayerClientServiceServer).RetrieveBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dalc.DataAvailabilityLayerClientService/RetrieveBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataAvailabilityLayerClientServiceServer).RetrieveBlock(ctx, req.(*RetrieveBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _DataAvailabilityLayerClientService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dalc.DataAvailabilityLayerClientService",
	HandlerType: (*DataAvailabilityLayerClientServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SubmitBlock",
			Handler:    _DataAvailabilityLayerClientService_SubmitBlock_Handler,
		},
		{
			MethodName: "CheckBlockAvailability",
			Handler:    _DataAvailabilityLayerClientService_CheckBlockAvailability_Handler,
		},
		{
			MethodName: "RetrieveBlock",
			Handler:    _DataAvailabilityLayerClientService_RetrieveBlock_Handler,
		},
	},
...
var fileDescriptorDalc = []byte{
	...
	,
}
