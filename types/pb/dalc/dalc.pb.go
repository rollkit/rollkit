...
import (
	...
	rollmint "github.com/celestiaorg/rollmint/types/pb/rollmint"
)
...
type SubmitBlockRequest struct {
	Block *rollmint.Block `protobuf:"bytes,1,opt,name=block,proto3" json:"block,omitempty"`
}
...
func (m *SubmitBlockRequest) GetBlock() *rollmint.Block {
	if m != nil {
		return m.Block
	}
	return nil
...
type RetrieveBlocksResponse struct {
	Result *DAResponse       `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	Blocks []*rollmint.Block `protobuf:"bytes,2,rep,name=blocks,proto3" json:"blocks,omitempty"`
}
...
func (m *RetrieveBlocksResponse) GetBlocks() []*rollmint.Block {
	if m != nil {
		return m.Blocks
	}
	return nil
...
var fileDescriptor_45d7d8eda2693dc1 = []byte{
	...
	,
}
...
func (m *RetrieveBlocksResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Blocks = append(m.Blocks, &rollmint.Block{})
