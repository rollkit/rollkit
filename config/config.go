...
const (
	...
	flagStateFraudProof = "rollkit.experimental_insecure_fraud_proofs"
...
type BlockManagerConfig struct {
	...
	StateFraudProof bool              `mapstructure:"fraud_proofs"`
}
...
func (nc *NodeConfig) GetViperConfig(v *viper.Viper) error {
	...
	nc.StateFraudProof = v.GetBool(flagStateFraudProof)
...
func AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(flagStateFraudProof, def.StateFraudProof, "enable fraud proofs (experimental & insecure)")
