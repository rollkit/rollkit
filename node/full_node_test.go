...
func TestStartup(t *testing.T) {
	...
	node, err := newFullNode(context.Background(), config.NodeConfig{DALayer: "mock", BlockManagerConfig: blockManagerConfig}, key, signingKey, proxy.NewLocalClientCreator(app), &types.GenesisDoc{ChainID: "test"}, log.TestingLogger())
	require.NoError(err)
	require.NotNil(node)
