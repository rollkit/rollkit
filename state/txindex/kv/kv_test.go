...
func TestTxSearch(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string("number"), Value: string("1"), Index: true}}},
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string("owner"), Value: string("Ivan"), Index: true}}},
		{Type: "", Attributes: []abci.EventAttribute{{Key: string("not_allowed"), Value: string("Vlad"), Index: true}}},
	})
...
func TestTxSearchOneTxWithMultipleSameTagsButDifferentValues(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string("number"), Value: string("1"), Index: true}}},
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string("number"), Value: string("2"), Index: true}}},
	})
...
func TestTxSearchMultipleTxs(t *testing.T) {
	...
	txResult3 := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string("number"), Value: string("3"), Index: true}}},
	})
