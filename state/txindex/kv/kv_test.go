...
func TestTxSearch(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("number")), Value: string([]byte("1")), Index: true}}},
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("owner")), Value: string([]byte("Ivan")), Index: true}}},
		{Type: "", Attributes: []abci.EventAttribute{{Key: string([]byte("not_allowed")), Value: string([]byte("Vlad")), Index: true}}},
	})
...
func TestTxSearchOneTxWithMultipleSameTagsButDifferentValues(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("number")), Value: string([]byte("1")), Index: true}}},
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("number")), Value: string([]byte("2")), Index: true}}},
	})
...
func TestTxSearchMultipleTxs(t *testing.T) {
	...
	txResult3 := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("number")), Value: string([]byte("3")), Index: true}}},
	})
	...
	txResult4 := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []abci.EventAttribute{{Key: string([]byte("number.id")), Value: string([]byte("1")), Index: true}}},
	})
