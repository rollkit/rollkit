...
func (e *ABCIExecutionClient) commit(ctx context.Context, state types.State, header *types.SignedHeader, data *types.Data, resp *abci.ResponseFinalizeBlock) ([]byte, uint64, error) {
	e.mempool.Lock()
...
func (e *ABCIExecutionClient) Validate(state types.State, header *types.SignedHeader, data *types.Data) error {
...
func (e *ABCIExecutionClient) execute(ctx context.Context, state types.State, header *types.SignedHeader, data *types.Data) (*abci.ResponseFinalizeBlock, error) {
...
func (e *ABCIExecutionClient) publishEvents(resp *abci.ResponseFinalizeBlock, header *types.SignedHeader, data *types.Data, state types.State) {
	if e.eventBus == nil {
		return
	}
